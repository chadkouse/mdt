            ...
            <div class="card custom-card">
                ...
                <div class="card-body">
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                <label for="channel">Criminal Record <a href="pnc-check.php?cid=<?php echo $vehicleInfo['cid']; ?>#record">View</a></label>
                            ...
                            <div class="form-group col-md-8">
                                <label for="channel">Owner <a href="pnc-check.php?cid=<?php echo $vehicleInfo['cid']; ?>">View</a></label>
                                <input type="text" class="form-control" name="vrm" value="<?php if(empty($vehicleInfo['owner'])) { echo "Unsold"; }else{ echo getVehicleOwner($vehicleInfo['owner'])['name'];  } ?>" disabled>
                            </div>
<!--                            <div class="form-group col-md-4">-->
